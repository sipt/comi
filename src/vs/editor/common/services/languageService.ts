...
import type { ILanguageNameIdPair, ILanguageSelection, ILanguageService, ILanguageIcon } from "vs/editor/common/languages/language";
import { firstOrDefault } from "vs/base/common/arrays";
import { type ILanguageIdCodec, TokenizationRegistry } from "vs/editor/common/languages";
...
class LanguageSelection implements ILanguageSelection {
  ...
  constructor(private readonly _onDidChangeLanguages: Event<void>, private readonly _selector: () => string) {
