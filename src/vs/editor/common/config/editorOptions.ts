...
export class EditorLayoutInfoComputer extends ComputedEditorOption<EditorOption.layoutInfo, EditorLayoutInfo> {
  ...
  public static computeContainedMinimapLineCount(input: { viewLineCount: number; scrollBeyondLastLine: boolean; height: number; lineHeight: number; pixelRatio: number }): {
  ...
  private static _computeMinimapLayout(input: IMinimapLayoutInput, memory: ComputeOptionsMemory): EditorMinimapLayoutInfo {
    ...
    const minimapWidth = Math.min(
      minimapMaxWidth,
      Math.max(0, Math.floor(((remainingWidth - verticalScrollbarWidth - 2) * minimapCharWidth) / (typicalHalfwidthCharacterWidth + minimapCharWidth))) + MINIMAP_GUTTER_WIDTH
    );
...
class UnicodeHighlight extends BaseEditorOption<EditorOption.unicodeHighlighting, IUnicodeHighlightOptions, InternalUnicodeHighlightOptions> {
  ...
  public override applyUpdate(
    value: Required<Readonly<IUnicodeHighlightOptions>>,
...
export const EditorOptions = {
  ...
  acceptSuggestionOnEnter: register(
    new EditorStringEnumOption(EditorOption.acceptSuggestionOnEnter, "acceptSuggestionOnEnter", "on" as "on" | "smart" | "off", ["on", "smart", "off"] as const, {
  ...
  accessibilityPageSize: register(
    new EditorIntOption(EditorOption.accessibilityPageSize, "accessibilityPageSize", 10, 1, Constants.MAX_SAFE_SMALL_INTEGER, {
      description: nls.localize(
        "accessibilityPageSize",
  ...
  autoClosingDelete: register(
    new EditorStringEnumOption(EditorOption.autoClosingDelete, "autoClosingDelete", "auto" as "always" | "auto" | "never", ["always", "auto", "never"] as const, {
      enumDescriptions: ["", nls.localize("editor.autoClosingDelete.auto", "Remove adjacent closing quotes or brackets only if they were automatically inserted."), ""],
      description: nls.localize("autoClosingDelete", "Controls whether the editor should remove adjacent closing quotes or brackets when deleting."),
    })
  ),
  autoClosingOvertype: register(
    new EditorStringEnumOption(EditorOption.autoClosingOvertype, "autoClosingOvertype", "auto" as "always" | "auto" | "never", ["always", "auto", "never"] as const, {
  ...
  autoIndent: register(
    new EditorEnumOption(EditorOption.autoIndent, "autoIndent", EditorAutoIndentStrategy.Full, "full", ["none", "keep", "brackets", "advanced", "full"], _autoIndentFromString, {
      enumDescriptions: [
  ...
  codeLensFontFamily: register(
    new EditorStringOption(EditorOption.codeLensFontFamily, "codeLensFontFamily", "", { description: nls.localize("codeLensFontFamily", "Controls the font family for CodeLens.") })
  ),
  ...
  cursorBlinking: register(
    new EditorEnumOption(EditorOption.cursorBlinking, "cursorBlinking", TextEditorCursorBlinkingStyle.Blink, "blink", ["blink", "smooth", "phase", "expand", "solid"], _cursorBlinkingStyleFromString, {
      description: nls.localize("cursorBlinking", "Control the cursor animation style."),
    })
  ),
  cursorSmoothCaretAnimation: register(
    new EditorBooleanOption(EditorOption.cursorSmoothCaretAnimation, "cursorSmoothCaretAnimation", false, {
  ...
  cursorSurroundingLines: register(
    new EditorIntOption(EditorOption.cursorSurroundingLines, "cursorSurroundingLines", 0, 0, Constants.MAX_SAFE_SMALL_INTEGER, {
      description: nls.localize(
        "cursorSurroundingLines",
  ...
  cursorSurroundingLinesStyle: register(
    new EditorStringEnumOption(EditorOption.cursorSurroundingLinesStyle, "cursorSurroundingLinesStyle", "default" as "default" | "all", ["default", "all"] as const, {
      enumDescriptions: [
  ...
  foldingStrategy: register(
    new EditorStringEnumOption(EditorOption.foldingStrategy, "foldingStrategy", "auto" as "auto" | "indentation", ["auto", "indentation"] as const, {
      enumDescriptions: [
  ...
  foldingHighlight: register(
    new EditorBooleanOption(EditorOption.foldingHighlight, "foldingHighlight", true, { description: nls.localize("foldingHighlight", "Controls whether the editor should highlight folded ranges.") })
  ),
  ...
  letterSpacing: register(
    new EditorFloatOption(EditorOption.letterSpacing, "letterSpacing", EDITOR_FONT_DEFAULTS.letterSpacing, (x) => EditorFloatOption.clamp(x, -5, 20), {
  ...
  matchBrackets: register(
    new EditorStringEnumOption(EditorOption.matchBrackets, "matchBrackets", "always" as "never" | "near" | "always", ["always", "near", "never"] as const, {
  ...
  mouseWheelScrollSensitivity: register(
    new EditorFloatOption(EditorOption.mouseWheelScrollSensitivity, "mouseWheelScrollSensitivity", 1, (x) => (x === 0 ? 1 : x), {
  ...
  multiCursorModifier: register(
    new EditorEnumOption(EditorOption.multiCursorModifier, "multiCursorModifier", "altKey", "alt", ["ctrlCmd", "alt"], _multiCursorModifierFromString, {
  ...
  multiCursorPaste: register(
    new EditorStringEnumOption(EditorOption.multiCursorPaste, "multiCursorPaste", "spread" as "spread" | "full", ["spread", "full"] as const, {
  ...
  occurrencesHighlight: register(
    new EditorBooleanOption(EditorOption.occurrencesHighlight, "occurrencesHighlight", true, {
  ...
  peekWidgetDefaultFocus: register(
    new EditorStringEnumOption(EditorOption.peekWidgetDefaultFocus, "peekWidgetDefaultFocus", "tree" as "tree" | "editor", ["tree", "editor"] as const, {
  ...
  quickSuggestionsDelay: register(
    new EditorIntOption(EditorOption.quickSuggestionsDelay, "quickSuggestionsDelay", 10, 0, Constants.MAX_SAFE_SMALL_INTEGER, {
  ...
  renderFinalNewline: register(
    new EditorBooleanOption(EditorOption.renderFinalNewline, "renderFinalNewline", true, {
  ...
  renderLineHighlight: register(
    new EditorStringEnumOption(EditorOption.renderLineHighlight, "renderLineHighlight", "line" as "none" | "gutter" | "line" | "all", ["none", "gutter", "line", "all"] as const, {
  ...
  renderValidationDecorations: register(
    new EditorStringEnumOption(EditorOption.renderValidationDecorations, "renderValidationDecorations", "editable" as "editable" | "on" | "off", ["editable", "on", "off"] as const)
  ),
  ...
  roundedSelection: register(
    new EditorBooleanOption(EditorOption.roundedSelection, "roundedSelection", true, { description: nls.localize("roundedSelection", "Controls whether selections should have rounded corners.") })
  ),
  rulers: register(new EditorRulers()),
  scrollbar: register(new EditorScrollbar()),
  scrollBeyondLastColumn: register(
    new EditorIntOption(EditorOption.scrollBeyondLastColumn, "scrollBeyondLastColumn", 5, 0, Constants.MAX_SAFE_SMALL_INTEGER, {
  ...
  showFoldingControls: register(
    new EditorStringEnumOption(EditorOption.showFoldingControls, "showFoldingControls", "mouseover" as "always" | "mouseover", ["always", "mouseover"] as const, {
      enumDescriptions: [
  ...
  showDeprecated: register(
    new EditorBooleanOption(EditorOption.showDeprecated, "showDeprecated", true, { description: nls.localize("showDeprecated", "Controls strikethrough deprecated variables.") })
  ),
  inlayHints: register(new EditorInlayHints()),
  snippetSuggestions: register(
    new EditorStringEnumOption(EditorOption.snippetSuggestions, "snippetSuggestions", "inline" as "top" | "bottom" | "inline" | "none", ["top", "bottom", "inline", "none"] as const, {
      enumDescriptions: [
  ...
  smoothScrolling: register(
    new EditorBooleanOption(EditorOption.smoothScrolling, "smoothScrolling", false, { description: nls.localize("smoothScrolling", "Controls whether the editor will scroll using an animation.") })
  ),
  ...
  tabCompletion: register(
    new EditorStringEnumOption(EditorOption.tabCompletion, "tabCompletion", "off" as "on" | "off" | "onlySnippets", ["on", "off", "onlySnippets"] as const, {
      enumDescriptions: [
  ...
  unusualLineTerminators: register(
    new EditorStringEnumOption(EditorOption.unusualLineTerminators, "unusualLineTerminators", "prompt" as "auto" | "off" | "prompt", ["auto", "off", "prompt"] as const, {
      enumDescriptions: [
  ...
  useTabStops: register(new EditorBooleanOption(EditorOption.useTabStops, "useTabStops", true, { description: nls.localize("useTabStops", "Inserting and deleting whitespace follows tab stops.") })),
  ...
  wordWrap: register(
    new EditorStringEnumOption(EditorOption.wordWrap, "wordWrap", "off" as "off" | "on" | "wordWrapColumn" | "bounded", ["off", "on", "wordWrapColumn", "bounded"] as const, {
      markdownEnumDescriptions: [
  ...
  wrappingIndent: register(
    new EditorEnumOption(EditorOption.wrappingIndent, "wrappingIndent", WrappingIndent.Same, "same", ["none", "same", "indent", "deepIndent"], _wrappingIndentFromString, {
      enumDescriptions: [
  ...
  wrappingStrategy: register(
    new EditorStringEnumOption(EditorOption.wrappingStrategy, "wrappingStrategy", "simple" as "simple" | "advanced", ["simple", "advanced"] as const, {
      enumDescriptions: [
        nls.localize(
