...
import { type ITextModel, shouldSynchronizeModel } from "vs/editor/common/model";
import { type LanguageFilter, type LanguageSelector, score } from "vs/editor/common/languageSelector";
