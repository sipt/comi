...
import { ColorId, FontStyle, type ILanguageIdCodec, type ITokenPresentation, MetadataConsts, StandardTokenType, TokenMetadata } from "vs/editor/common/languages";
...
export class LineTokens implements IViewLineTokens {
  ...
  public static defaultTokenMetadata =
    ((FontStyle.None << MetadataConsts.FONT_STYLE_OFFSET) | (ColorId.DefaultForeground << MetadataConsts.FOREGROUND_OFFSET) | (ColorId.DefaultBackground << MetadataConsts.BACKGROUND_OFFSET)) >>> 0;
