...
import { type IAutoClosingPair, StandardAutoClosingPairConditional, type LanguageConfiguration, type CharacterPair } from "vs/editor/common/languages/languageConfiguration";
...
export class CharacterPairSupport {
  ...
  constructor(config: LanguageConfiguration) {
    ...
    if (config.colorizedBracketPairs) {
      ...
      this._colorizedBracketPairs = filterValidBrackets(
        config.brackets
