...
import { Disposable, type IDisposable, toDisposable } from "vs/base/common/lifecycle";
...
import {
  ...
  AutoClosingPairs,
  type CharacterPair,
  type ExplicitLanguageConfiguration,
...
export class LanguageConfigurationService extends Disposable implements ILanguageConfigurationService {
  ...
  constructor(@IConfigurationService private readonly configurationService: IConfigurationService, @ILanguageService private readonly languageService: ILanguageService) {
    super();
...
function computeConfig(languageId: string, configurationService: IConfigurationService, languageService: ILanguageService): ResolvedLanguageConfiguration {
