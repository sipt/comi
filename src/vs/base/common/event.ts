...
import { combinedDisposable, Disposable, DisposableStore, type IDisposable, SafeDisposable, toDisposable } from "vs/base/common/lifecycle";
...
class EventProfiling {
  ...
  stop(): void {
    if (this._stopWatch) {
      ...
      console.info(
        `did FIRE ${this._name}: elapsed_ms: ${elapsed.toFixed(5)}, listener: ${this._listenerCount} (elapsed_overall: ${this._elapsedOverall.toFixed(2)}, invocations: ${this._invocationCount})`
      );
