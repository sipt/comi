...
import type { Keybinding } from "vs/base/common/keyCodes";
import type { OperatingSystem } from "vs/base/common/platform";
...
export class KeybindingParser {
  ...
  static parseUserBinding(
    input: string
  ): (SimpleKeybinding | ScanCodeBinding)[] {
    if (!input) {
      return [];
    }
