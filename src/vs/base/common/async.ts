...
import { Disposable, type IDisposable, MutableDisposable, toDisposable } from "vs/base/common/lifecycle";
import { extUri as defaultExtUri, type IExtUri } from "vs/base/common/resources";
...
export class CancelableAsyncIterableObject<T> extends AsyncIterableObject<T> {
  constructor(private readonly _source: CancellationTokenSource, executor: AyncIterableExecutor<T>) {
    super(executor);
  }
