...
export class GlobalPointerMoveMonitor<R extends { buttons: number } = IPointerMoveEventData> implements IDisposable {
  ...
  public startMonitoring(
    ...
    this._hooks.add(
      dom.addDisposableThrottledListener<R, PointerEvent>(
        initialElement,
    ...
    this._hooks.add(dom.addDisposableListener(initialElement, dom.EventType.POINTER_UP, (e: PointerEvent) => this.stopMonitoring(true)));
  }
}
