...
import { type ISashEvent as IBaseSashEvent, Orientation, Sash, SashState } from "vs/base/browser/ui/sash/sash";
import { SmoothScrollableElement } from "vs/base/browser/ui/scrollbar/scrollableElement";
import { pushToEnd, pushToStart, range } from "vs/base/common/arrays";
import { Color } from "vs/base/common/color";
import { Emitter, Event } from "vs/base/common/event";
import { combinedDisposable, Disposable, dispose, type IDisposable, toDisposable } from "vs/base/common/lifecycle";
...
abstract class ViewItem<TLayoutContext> {
  ...
  constructor(protected container: HTMLElement, private view: IView<TLayoutContext>, size: ViewItemSize, private disposable: IDisposable) {
