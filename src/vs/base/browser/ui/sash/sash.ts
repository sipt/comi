...
import { $, append, createStyleSheet, EventHelper, type EventLike, getElementsByTagName } from "vs/base/browser/dom";
import { DomEmitter } from "vs/base/browser/event";
import { EventType, Gesture, type GestureEvent } from "vs/base/browser/touch";
