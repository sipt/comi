...
import { GlobalMouseMoveMonitor, standardMouseMoveMerger } from "vs/base/browser/globalMouseMoveMonitor";
import type { IStandardMouseMoveEventData } from "vs/base/browser/globalMouseMoveMonitor";
import type { IMouseEvent, StandardWheelEvent } from "vs/base/browser/mouseEvent";
import type { ScrollbarArrowOptions } from "vs/base/browser/ui/scrollbar/scrollbarArrow";
import { ScrollbarArrow } from "vs/base/browser/ui/scrollbar/scrollbarArrow";
import type { ScrollbarState } from "vs/base/browser/ui/scrollbar/scrollbarState";
import { ScrollbarVisibilityController } from "vs/base/browser/ui/scrollbar/scrollbarVisibilityController";
import { Widget } from "vs/base/browser/ui/widget";
import * as platform from "vs/base/common/platform";
import type { INewScrollPosition, Scrollable, ScrollbarVisibility } from "vs/base/common/scrollable";
...
export abstract class AbstractScrollbar extends Widget {
  ...
  constructor(opts: AbstractScrollbarOptions) {
    ...
    this._visibilityController = this._register(
      new ScrollbarVisibilityController(opts.visibility, "visible scrollbar " + opts.extraScrollbarClassName, "invisible scrollbar " + opts.extraScrollbarClassName)
    );
