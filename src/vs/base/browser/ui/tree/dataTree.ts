...
import type { IIdentityProvider, IListVirtualDelegate } from "vs/base/browser/ui/list/list";
import { AbstractTree, AbstractTreeViewState, type IAbstractTreeOptions } from "vs/base/browser/ui/tree/abstractTree";
import type { IList } from "vs/base/browser/ui/tree/indexTreeModel";
import { ObjectTreeModel } from "vs/base/browser/ui/tree/objectTreeModel";
import { type IDataSource, type ITreeElement, type ITreeModel, type ITreeNode, type ITreeRenderer, type ITreeSorter, TreeError } from "vs/base/browser/ui/tree/tree";
...
export class DataTree<TInput, T, TFilterData = void> extends AbstractTree<T | null, TFilterData, T | null> {
  protected get _model(): ObjectTreeModel<T, TFilterData> {
