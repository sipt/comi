...
import { type DistributeSizing, type ISplitViewStyles, type IView as ISplitView, LayoutPriority, Sizing, SplitView } from "vs/base/browser/ui/splitview/splitview";
...
import { Disposable, DisposableStore, type IDisposable, toDisposable } from "vs/base/common/lifecycle";
