    ...
    if (this.element) {
      ...
      const menuActionsProvider = {
        getActions: () => {
          ...
          return [
            this._action,
            ...(Array.isArray(actionsProvider) ? actionsProvider : (actionsProvider as IActionProvider).getActions()), // TODO: microsoft/TypeScript#42768
          ];
        },
      };
      this.dropdownMenuActionViewItem = new DropdownMenuActionViewItem(this._register(new Action("dropdownAction", undefined)), menuActionsProvider, this.contextMenuProvider, {
        classNames: ["dropdown", ...Codicon.dropDownButton.classNamesArray, ...((<IActionWithDropdownActionViewItemOptions>this.options).menuActionClassNames || [])],
      });
