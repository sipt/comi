...
import { Disposable, dispose, type IDisposable } from "vs/base/common/lifecycle";
import { type IIPCLogger, type IMessagePassingProtocol, IPCClient } from "vs/base/parts/ipc/common/ipc";
