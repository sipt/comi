...
import { type ClientConnectionEvent, IPCServer } from "vs/base/parts/ipc/common/ipc";
import { ChunkStream, Client, type ISocket, Protocol, type SocketCloseEvent, SocketCloseEventType, SocketDiagnostics, SocketDiagnosticsEventType } from "vs/base/parts/ipc/common/ipc.net";
...
class ZlibInflateStream extends Disposable {
  ...
  constructor(private readonly _tracer: ISocketTracer, private readonly _recordInflateBytes: boolean, inflateBytes: VSBuffer | null, options: zlib.ZlibOptions) {
    super();
...
class ZlibDeflateStream extends Disposable {
  ...
  constructor(private readonly _tracer: ISocketTracer, options: zlib.ZlibOptions) {
    super();
