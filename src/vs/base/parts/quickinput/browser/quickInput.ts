...
import type { ActionViewItem } from "vs/base/browser/ui/actionbar/actionViewItems";
...
import type { IInputBoxStyles } from "vs/base/browser/ui/inputbox/inputBox";
import type { IKeybindingLabelStyles } from "vs/base/browser/ui/keybindingLabel/keybindingLabel";
import type { IListRenderer, IListVirtualDelegate } from "vs/base/browser/ui/list/list";
import type { IListOptions, IListStyles, List } from "vs/base/browser/ui/list/listWidget";
import { type IProgressBarStyles, ProgressBar } from "vs/base/browser/ui/progressbar/progressbar";
...
class QuickPick<T extends IQuickPickItem> extends QuickInput implements IQuickPick<T> {
  ...
  override show() {
    if (!this.visible) {
      ...
      this.visibleDisposables.add(
        (this._hideInput ? this.ui.list : this.ui.inputBox).onKeyDown((event: KeyboardEvent | StandardKeyboardEvent) => {
...
export class QuickInputController extends Disposable {
  ...
  private getUI() {
    ...
    this._register(
      dom.addDisposableListener(container, dom.EventType.KEY_DOWN, (e: KeyboardEvent) => {
