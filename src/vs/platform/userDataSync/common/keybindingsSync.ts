...
import { AbstractInitializer, AbstractJsonFileSynchroniser, type IAcceptResult, type IFileResourcePreview, type IMergeResult } from "vs/platform/userDataSync/common/abstractSynchronizer";
...
export class KeybindingsSynchroniser extends AbstractJsonFileSynchroniser implements IUserDataSynchroniser {
  ...
  constructor(
    ...
    super(
      environmentService.keybindingsResource,
    ...
    if (remoteContent) {
      ...
      if (this.hasErrors(localContent)) {
        throw new UserDataSyncError(
          localize("errorInvalidSettings", "Unable to sync keybindings because the content in the file is not valid. Please open the file and correct it."),
