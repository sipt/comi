...
import { AbstractFileSynchroniser, AbstractInitializer, type IAcceptResult, type IFileResourcePreview, type IMergeResult } from "vs/platform/userDataSync/common/abstractSynchronizer";
import {
  Change,
...
export class TasksSynchroniser extends AbstractFileSynchroniser implements IUserDataSynchroniser {
  ...
  constructor(
    ...
    super(
      uriIdentityService.extUri.joinPath(uriIdentityService.extUri.dirname(environmentService.settingsResource), "tasks.json"),
      SyncResource.Tasks,
      fileService,
      environmentService,
      storageService,
...
export class TasksInitializer extends AbstractInitializer {
  private tasksResource = this.uriIdentityService.extUri.joinPath(this.uriIdentityService.extUri.dirname(this.environmentService.settingsResource), "tasks.json");
  ...
  constructor(
    ...
    super(SyncResource.Tasks, environmentService, logService, fileService, uriIdentityService);
  }
