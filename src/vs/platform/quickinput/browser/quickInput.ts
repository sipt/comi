...
import type { List } from "vs/base/browser/ui/list/listWidget";
import { CancellationToken } from "vs/base/common/cancellation";
import { type IQuickInputOptions, type IQuickInputStyles, QuickInputController } from "vs/base/parts/quickinput/browser/quickInput";
import { IAccessibilityService } from "vs/platform/accessibility/common/accessibility";
import { type IContextKey, IContextKeyService, RawContextKey } from "vs/platform/contextkey/common/contextkey";
import { IInstantiationService } from "vs/platform/instantiation/common/instantiation";
import { ILayoutService } from "vs/platform/layout/browser/layoutService";
import { type IWorkbenchListOptions, WorkbenchList } from "vs/platform/list/browser/listService";
...
export class QuickInputService extends Themable implements IQuickInputService {
  ...
  protected createController(host: IQuickInputControllerHost = this.layoutService, options?: Partial<IQuickInputOptions>): QuickInputController {
    const defaultOptions: IQuickInputOptions = {
      ...
      createList: <T>(user: string, container: HTMLElement, delegate: IListVirtualDelegate<T>, renderers: IListRenderer<T, any>[], options: IWorkbenchListOptions<T>) =>
