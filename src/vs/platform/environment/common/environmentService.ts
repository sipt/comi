...
import type { NativeParsedArgs } from "vs/platform/environment/common/argv";
import type { ExtensionKind, IDebugParams, IExtensionHostDebugParams, INativeEnvironmentService } from "vs/platform/environment/common/environment";
...
export abstract class AbstractNativeEnvironmentService implements INativeEnvironmentService {
  ...
  get userDataSyncHome(): URI {
    return joinPath(this.userRoamingDataHome, "sync");
  }
  ...
  get userDataSyncLogResource(): URI {
    return URI.file(join(this.logsPath, "userDataSync.log"));
  }
  ...
  get installSourcePath(): string {
    return join(this.userDataPath, "installSource");
  }
  ...
  get debugExtensionHost(): IExtensionHostDebugParams {
    return parseExtensionHostPort(this.args, this.isBuilt);
  }
  ...
  get driverHandle(): string | undefined {
    return this.args["driver"];
  }

  @memoize
  get telemetryLogResource(): URI {
    return URI.file(join(this.logsPath, "telemetry.log"));
  }
