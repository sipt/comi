...
import { getIconRegistry, IconContribution, type IconFontDefinition } from "vs/platform/theme/common/iconRegistry";
import { type IProductIconTheme, IThemeService, ThemeIcon } from "vs/platform/theme/common/themeService";
