...
import type { IThemable, styleFn } from "vs/base/common/styler";
import {
...
import type { IColorTheme, IThemeService } from "vs/platform/theme/common/themeService";
...
export function attachKeybindingLabelStyler(widget: IThemable, themeService: IThemeService, style?: IKeybindingLabelStyleOverrides): IDisposable {
  return attachStyler(
    ...
    } as IKeybindingLabelStyleOverrides,
    widget
  );
}
