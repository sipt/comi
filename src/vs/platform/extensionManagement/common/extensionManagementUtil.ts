...
import type { IExtensionIdentifier, IGalleryExtension, ILocalExtension, IExtensionsControlManifest } from "vs/platform/extensionManagement/common/extensionManagement";
import { ExtensionIdentifier, type IExtension } from "vs/platform/extensions/common/extensions";
...
export class ExtensionIdentifierWithVersion {
  ...
  constructor(identifier: IExtensionIdentifier, readonly version: string) {
