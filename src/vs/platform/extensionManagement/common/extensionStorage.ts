...
import { IStorageService, type IStorageValueChangeEvent, StorageScope, StorageTarget } from "vs/platform/storage/common/storage";
...
import type { IGalleryExtension } from "vs/platform/extensionManagement/common/extensionManagement";
  ...
  setExtensionState(extension: IExtension | IGalleryExtension | string, state: IStringDictionary<any> | undefined, global: boolean): void {
    ...
    if (state === undefined) {
      ...
      this.storageService.store(
        ...
        global ? StorageScope.GLOBAL : StorageScope.WORKSPACE,
