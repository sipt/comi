...
import { type CancelablePromise, createCancelablePromise } from "vs/base/common/async";
import { VSBuffer } from "vs/base/common/buffer";
import { CancellationToken, CancellationTokenSource } from "vs/base/common/cancellation";
import { isCancellationError, onUnexpectedError } from "vs/base/common/errors";
import { Emitter } from "vs/base/common/event";
import { Disposable, DisposableStore, type IDisposable } from "vs/base/common/lifecycle";
import { generateUuid } from "vs/base/common/uuid";
import type { IIPCLogger } from "vs/base/parts/ipc/common/ipc";
import { Client, type ISocket, PersistentProtocol, SocketCloseEventType } from "vs/base/parts/ipc/common/ipc.net";
import type { ILogService } from "vs/platform/log/common/log";
import type { RemoteAgentConnectionContext } from "vs/platform/remote/common/remoteAgentEnvironment";
import { RemoteAuthorityResolverError } from "vs/platform/remote/common/remoteAuthorityResolver";
import type { ISignService } from "vs/platform/sign/common/sign";
...
async function connectToRemoteExtensionHostAgent(
