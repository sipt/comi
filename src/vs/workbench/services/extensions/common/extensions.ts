...
import type { IExtensionPoint } from "vs/workbench/services/extensions/common/extensionsRegistry";
import { ExtensionIdentifier, type IExtension, ExtensionType, type IExtensionDescription, type IExtensionContributions } from "vs/platform/extensions/common/extensions";
...
import type { ApiProposalName } from "vs/workbench/services/extensions/common/extensionsApiProposals";
import type { IV8Profile } from "vs/platform/profiling/common/profiling";
...
export function checkProposedApiEnabled(extension: IExtensionDescription, proposal: ApiProposalName): void {
  if (!isProposedApiEnabled(extension, proposal)) {
    throw new Error(
      ...
      } but NOT ${proposal}.\n The missing proposal MUST be added and you must start in extension development mode or use the following command line switch: --enable-proposed-api ${
