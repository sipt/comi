...
import { Disposable, dispose, type IDisposable, MutableDisposable } from "vs/base/common/lifecycle";
...
import type { ICredentialsService } from "vs/platform/credentials/common/credentials";
...
const FIRST_PARTY_ALLOWED_EXTENSIONS = ["github.vscode-pull-request-github", "vscode.git", "github.remotehub", "github.remotehub-insiders", "github.codespaces", "ms-vsliveshare.vsliveshare"];
...
export class AuthenticationService extends Disposable implements IAuthenticationService {
  ...
  private _onDidChangeSessions: Emitter<{ providerId: string; label: string; event: AuthenticationSessionsChangeEvent }> = this._register(
  ...
  isAccessAllowed(providerId: string, accountName: string, extensionId: string): boolean | undefined {
    ...
    const allowedAllowedExtensions = remoteConnection !== null ? remoteConnection.remoteAuthority.startsWith("codespaces") : isWeb;
