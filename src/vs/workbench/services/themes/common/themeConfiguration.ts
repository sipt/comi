...
const detectHCSchemeSettingSchema: IConfigurationPropertySchema = {
  ...
  markdownDescription: nls.localize(
    ...
    "If enabled, will automatically change to high contrast theme if the OS is using a high contrast theme. The high contrast theme to use is specified by `#{0}#`",
    ThemeSettings.PREFERRED_HC_THEME
  ),
