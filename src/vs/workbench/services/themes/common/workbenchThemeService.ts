...
import { type IColorTheme, IThemeService, type IFileIconTheme, type IProductIconTheme } from "vs/platform/theme/common/themeService";
...
import type { IconContribution, IconDefinition } from "vs/platform/theme/common/iconRegistry";
