...
export const settingsHeaderBorder = registerColor(
  ...
  { dark: PANEL_BORDER, light: PANEL_BORDER, hc: PANEL_BORDER },
...
export const settingsSelectListBorder = registerColor(
  ...
  localize("settingsDropdownListBorder", "Settings editor dropdown list border. This surrounds the options and separates the options from the description.")
);

// Bool control colors
export const settingsCheckboxBackground = registerColor(
  "settings.checkboxBackground",
  { dark: checkboxBackground, light: checkboxBackground, hc: checkboxBackground },
...
export const settingsCheckboxForeground = registerColor(
  ...
  { dark: checkboxForeground, light: checkboxForeground, hc: checkboxForeground },
...
export const settingsCheckboxBorder = registerColor(
  ...
  { dark: checkboxBorder, light: checkboxBorder, hc: checkboxBorder },
