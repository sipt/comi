...
import type { IPager } from "vs/base/common/paging";
import type {
  IQueryOptions,
  ILocalExtension,
  IGalleryExtension,
...
import type { EnablementState, IExtensionManagementServer } from "vs/workbench/services/extensionManagement/common/extensionManagement";
import type { CancellationToken } from "vs/base/common/cancellation";
import { Disposable } from "vs/base/common/lifecycle";
import { areSameExtensions } from "vs/platform/extensionManagement/common/extensionManagementUtil";
import type { IExtensionManifest, ExtensionType } from "vs/platform/extensions/common/extensions";
import type { URI } from "vs/base/common/uri";
import type { IView, IViewPaneContainer } from "vs/workbench/common/views";
import { RawContextKey } from "vs/platform/contextkey/common/contextkey";
import type { IExtensionsStatus } from "vs/workbench/services/extensions/common/extensions";
import type { IExtensionEditorOptions } from "vs/workbench/contrib/extensions/common/extensionsInput";
...
export class ExtensionContainers extends Disposable {
  constructor(private readonly containers: IExtensionContainer[], @IExtensionsWorkbenchService extensionsWorkbenchService: IExtensionsWorkbenchService) {
    super();
