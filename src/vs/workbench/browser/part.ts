...
import type { IThemeService, IColorTheme } from "vs/platform/theme/common/themeService";
import { Dimension, size, type IDimension } from "vs/base/browser/dom";
import type { IStorageService } from "vs/platform/storage/common/storage";
import type { ISerializableView, IViewSize } from "vs/base/browser/ui/grid/grid";
import { Event, Emitter } from "vs/base/common/event";
import type { IWorkbenchLayoutService } from "vs/workbench/services/layout/browser/layoutService";
