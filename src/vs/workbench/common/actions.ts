...
import { type ICommandHandler, CommandsRegistry } from "vs/platform/commands/common/commands";
import { SyncActionDescriptor, MenuRegistry, MenuId } from "vs/platform/actions/common/actions";
import { IInstantiationService } from "vs/platform/instantiation/common/instantiation";
import { type IDisposable, DisposableStore } from "vs/base/common/lifecycle";
import { ILifecycleService, LifecyclePhase } from "vs/workbench/services/lifecycle/common/lifecycle";
import { INotificationService } from "vs/platform/notification/common/notification";
import { ContextKeyExpr, type ContextKeyExpression } from "vs/platform/contextkey/common/contextkey";
...
Registry.add(
  ...
  new (class implements IWorkbenchActionRegistry {
    ...
    private registerWorkbenchCommandFromAction(descriptor: SyncActionDescriptor, alias: string, category?: string, when?: ContextKeyExpression): IDisposable {
      ...
      KeybindingsRegistry.registerKeybindingRule({
        id: descriptor.id,
        weight: weight,
        when: descriptor.keybindingContext && when ? ContextKeyExpr.and(descriptor.keybindingContext, when) : descriptor.keybindingContext || when || null,
